"""
Django settings for app_base project.
...
SECRET_KEY = 'django-insecure-)#tvjg64kxdvi*ni8d$y2-=2vwzt@7!-7y-fmtxb-*nw(sa=he'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['for-deploy-iqdx.onrender.com']
